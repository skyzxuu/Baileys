...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    profilePictureUrl: (jid: string, type?: "image" | "preview", timeoutMs?: number | undefined) => Promise<string | null | undefined>;
    ...
    newsletterQuery: (jid: string, type: "get" | "set", content: import("../index").BinaryNode[]) => Promise<import("../index").BinaryNode>;
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object | undefined) => Promise<import("../index").BinaryNode>;
    ...
    groupQuery: (jid: string, type: "get" | "set", content: import("../index").BinaryNode[]) => Promise<import("../index").BinaryNode>;
    ...
    interactiveQuery: (userNodes: import("../index").BinaryNode[], queryNode: import("../index").BinaryNode) => Promise<import("../index").BinaryNode[]>;
    processingMutex: {
