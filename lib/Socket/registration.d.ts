...
export declare const makeRegistrationSocket: (config: SocketConfig) => {
    ...
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object | undefined) => Promise<import("../WABinary").BinaryNode>;
    ...
    groupQuery: (jid: string, type: "get" | "set", content: import("../WABinary").BinaryNode[]) => Promise<import("../WABinary").BinaryNode>;
    ...
    interactiveQuery: (userNodes: import("../WABinary").BinaryNode[], queryNode: import("../WABinary").BinaryNode) => Promise<import("../WABinary").BinaryNode[]>;
    processingMutex: {
